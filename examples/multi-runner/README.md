...
- Linux Ubuntu 24.04 `["self-hosted", "linux", "x64", "[self-hosted, linux, x64, ubuntu-terraform]"]` or `["self-hosted", "linux", "x64", "ubuntu-2404"]`: Ubuntu runners non ephemeral based on a custom start script.
